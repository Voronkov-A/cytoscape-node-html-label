...
const $$find = function <T>(arr: T[], predicate: (a: T, i: number, arr: T[]) => boolean) {
...
export function cyNodeHtmlLabel(_cy: Core, params: CytoscapeNodeHtmlParams[], options?: CytoscapeContainerParams) {
...
(<any>cytoscape).nodeHtmlLabel = cyNodeHtmlLabel;
